  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-16 text-center">
      ...
      <p className="text-lg text-gray-700 mb-12">
        Prefer a more direct approach? Connect with us using the details below. Whether by phone or email, we’re always
        ready to help you navigate your trading journey.
      </p>
