      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center px-4 sm:px-6 lg:px-8">
        ...
        <div>
          ...
          <p className="text-gray-300 text-base leading-relaxed mb-6">
            ...
            leverage options tailored to suit your unique investment strategy. Our platform is designed to enhance your
            trading experience, allowing you to make informed decisions and maximize your potential for success.
          </p>
          <p className="text-gray-300 text-base leading-relaxed">
            ...
            skills needed to navigate the financial markets with confidence. Start building your trading portfolio with
            CFD Capitals today!
          </p>
        </div>
