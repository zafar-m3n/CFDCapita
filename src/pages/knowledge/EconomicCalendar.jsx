      ...
      <div className="max-w-5xl mx-auto px-6 py-16 text-center">
        ...
        >
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            An economic calendar tracks significant national and global events that can influence the prices and trends
            in the global economy, financial markets, and assets in real time. This schedule of upcoming events has the
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto mt-4">
            ...
            essential. Even long-term CFD investors will benefit from staying updated on key economic releases,
          ...
          >
            <div className="bg-gray-50 hover:bg-green-50 rounded-2xl p-8 text-center transition-colors flex flex-col items-center justify-center">
              ...
              <p className="text-base text-gray-700">
                The calendar organizes events by date and time, allowing traders to schedule their activities
                effectively.
              </p>
            </div>
          </AnimatedContent>
